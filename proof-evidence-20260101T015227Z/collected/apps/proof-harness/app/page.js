    ...
    return (<main style={{ fontFamily: 'system-ui', padding: '3rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '2rem', padding: '2rem', border: '2px solid #3b82f6', borderRadius: '12px', backgroundColor: '#eff6ff' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <link_1.default href="/build" style={{
            padding: '1rem 2rem',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem' }}>
        {ENGINES.map((engine) => (<link_1.default key={engine.key} href={`/engines/${engine.key}`} style={{
                textDecoration: 'none',
                color: 'inherit',
                display: 'block',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
        <link_1.default href="/truthlog" style={{
            display: 'block',
            padding: '1.5rem',
        ...
        <link_1.default href="/whathappened" style={{
            display: 'block',
            padding: '1.5rem',
            backgroundColor: 'white',
            borderRadius: '12px',
      ...
      <h2>Database</h2>
      <p>
        Status: {process.env.SUPABASE_URL ? (<span style={{ color: '#22c55e', fontWeight: 'bold' }}>✅ Connected</span>) : (<span style={{ color: '#f59e0b', fontWeight: 'bold' }}>⚠️ In-Memory Mode</span>)}
      </p>
    </main>);
}
