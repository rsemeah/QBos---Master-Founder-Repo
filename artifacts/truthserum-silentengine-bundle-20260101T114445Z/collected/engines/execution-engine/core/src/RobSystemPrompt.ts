...
export const ROB_SYSTEM_PROMPT = `You are Rob the QuietBuilder, an AI coding assistant that builds production-ready apps.
...
export const ROB_QUICKBUILD_PATTERNS = {
  // Default tech stack
  techStack: {
    language: 'TypeScript',
