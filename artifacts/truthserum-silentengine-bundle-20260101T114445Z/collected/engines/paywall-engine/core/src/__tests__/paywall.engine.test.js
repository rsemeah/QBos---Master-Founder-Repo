...
const paywall_engine_1 = require("../paywall.engine");
describe('PaywallEngine', () => {
    let engine;
    beforeEach(() => {
        engine = new paywall_engine_1.PaywallEngine();
    });
    describe('getPlan', () => {
    ...
    describe('createSubscription', () => {
        ...
        it('should throw error for non-existent plan', async () => {
            await expect(engine.createSubscription('user123', 'non-existent')).rejects.toThrow();
        });
    });
...
//# sourceMappingURL=paywall.engine.test.js.map