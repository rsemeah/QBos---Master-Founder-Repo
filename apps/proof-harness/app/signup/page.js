        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <div>
              ...
              <input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="••••••••"/>
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            ...
            <link_1.default href="/login" className="text-blue-600 hover:text-blue-700 font-medium">
              Log in
            </link_1.default>
          </div>
        </div>
