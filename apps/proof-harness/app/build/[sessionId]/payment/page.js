...
function PaymentPage({ params }) {
    ...
    const loadSession = async () => {
        try {
            ...
            const paymentIntent = await (0, api_1.createPaymentIntent)(params.sessionId);
    ...
    return (<div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <link_1.default href={`/build/${params.sessionId}`} className="text-sm text-blue-600 hover:text-blue-700">
            ← Back to Build
          </link_1.default>
        </div>
      </header>
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          {clientSecret && (<react_stripe_js_1.Elements stripe={stripePromise} options={{
                clientSecret,
                appearance: {
                    theme: 'stripe',
                    variables: {
              ...
              <PaymentForm_1.default sessionId={params.sessionId} onSuccess={handlePaymentSuccess}/>
            </react_stripe_js_1.Elements>)}

          {!clientSecret && !error && (<div className="text-center py-8">
