...
import { getBuildSession, BuildSession } from '../../../lib/api';
import Link from 'next/link';

export default function CompletePage({ params }: { params: { sessionId: string } }) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            {hasRepo ? (
              <>
                ...
                <a
                  ...
                  className="inline-block w-full text-center bg-gray-900 text-white py-2 px-4 rounded-md hover:bg-gray-800 font-medium"
                >
                  Open Repository →
                </a>
              </>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {hasDeployment ? (
              <>
                ...
                <a
                  href={session.vercel_deployment_url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block w-full text-center bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 font-medium"
                >
                  View Live App →
                </a>
              </>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/build/new"
            className="inline-block bg-blue-600 text-white px-8 py-3 rounded-md hover:bg-blue-700 font-medium text-center"
          >
            Build Another App
          </Link>
          <Link
            href="/dashboard"
            className="inline-block bg-white text-gray-700 px-8 py-3 rounded-md hover:bg-gray-50 border border-gray-300 font-medium text-center"
          >
            View All Builds
          </Link>
        </div>
