...
export default function BuildProgressPage({ params }: { params: { sessionId: string } }) {
            ...
            {steps.map((step, index) => (
              <div key={index} className="flex items-center gap-4">
                ...
                {index < steps.length - 1 && (
                  <div className={`absolute left-8 h-full w-0.5 ${
        ...
        {showCompleteButton && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
            ...
            <Link
              ...
              className="inline-block bg-green-600 text-white px-8 py-3 rounded-md hover:bg-green-700 font-medium"
            >
              View Your App
            </Link>
          </div>
