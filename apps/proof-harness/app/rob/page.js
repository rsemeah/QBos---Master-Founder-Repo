...
exports.default = RobBuilderPage;
const react_1 = require("react");
const ChatPanel_1 = require("./components/ChatPanel");
const GuidedSetupPanel_1 = require("./components/GuidedSetupPanel");
const PreviewPanel_1 = require("./components/PreviewPanel");
const TruthStatusPanel_1 = require("./components/TruthStatusPanel");
const ReceiptsViewer_1 = require("./components/ReceiptsViewer");
function RobBuilderPage() {
    const [sessionId, setSessionId] = (0, react_1.useState)('');
    const [messages, setMessages] = (0, react_1.useState)([]);
    const [receipts, setReceipts] = (0, react_1.useState)([]);
    const [truthState, setTruthState] = (0, react_1.useState)(null);
    const [selectedTemplateId, setSelectedTemplateId] = (0, react_1.useState)(null);
    const [selectedPaletteId, setSelectedPaletteId] = (0, react_1.useState)(null);
    (0, react_1.useEffect)(() => {
        createSession();
    ...
    const promptOptions = [
        {
            ...
            message: 'I want an app that helps people schedule pickup basketball games in major US cities.',
        },
        {
            id: 'booking',
    ...
    async function handlePaletteSelect(paletteId) {
    ...
    async function handlePromptSend(message) {
    ...
    return (<div className="flex flex-col h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          {truthState && (<div className={`px-4 py-2 rounded-lg font-semibold ${truthState.state === 'Verified'
      ...
      <div className="flex-1 flex overflow-hidden">
        <div className="w-1/2 border-r border-gray-200 flex flex-col">
          <GuidedSetupPanel_1.GuidedSetupPanel prompts={promptOptions} templates={templateOptions} palettes={paletteOptions} selectedTemplateId={selectedTemplateId} selectedPaletteId={selectedPaletteId} onSelectTemplate={handleTemplateSelect} onSelectPalette={handlePaletteSelect} onSendPrompt={handlePromptSend}/>
          <ChatPanel_1.ChatPanel messages={messages} onSendMessage={sendMessage} disabled={!sessionId}/>
        </div>

        <div className="w-1/2 flex flex-col">
          <PreviewPanel_1.PreviewPanel receipts={receipts}/>
          <div className="border-t border-gray-200">
            <TruthStatusPanel_1.TruthStatusPanel truthState={truthState}/>
          </div>
        </div>
      </div>

      <div className="border-t border-gray-200 bg-white">
        <ReceiptsViewer_1.ReceiptsViewer receipts={receipts}/>
      </div>
    </div>);
}
