...
class BuildSession {
     ...
     */
    async create(userId, ideaDescription) {
    ...
    async matchTemplate(sessionId) {
        ...
        const matches = templates.filter(template => template.keywords.some((keyword) => ideaLower.includes(keyword.toLowerCase())));
...
//# sourceMappingURL=BuildSessionManager.js.map