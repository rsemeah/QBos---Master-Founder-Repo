...
class StepRegistry {
    ...
    getStepsForGoals(goals) {
        return Array.from(this.steps.values()).filter((step) => step.goalTags.some((tag) => goals.includes(tag)));
    }
    registerDefaultSteps() {
        ...
        this.registerStep({
            ...
            explanation: "Let's make sure your computer has everything it needs to build. We'll check for Node.js and TypeScript.",
            actionType: 'check',
        ...
        this.registerStep({
            ...
            explanation: "We'll see if you have a database connected. If not, that's okay - we can use temporary storage for now.",
            actionType: 'check',
        ...
        this.registerStep({
            ...
            explanation: "Every app needs to know who's using it. We'll set up a way to create users and keep them logged in safely.",
            actionType: 'generate',
        ...
        this.registerStep({
            ...
            explanation: "If you're using AI or collecting data, you need permission. We'll help you keep track of what users agree to.",
            actionType: 'generate',
        ...
        this.registerStep({
            ...
            explanation: "Feature flags let you turn things on and off without changing code. Super useful for testing new features safely.",
            actionType: 'generate',
        ...
        this.registerStep({
            ...
            explanation: "Let's look at what we built together and make sure it all makes sense before we finish.",
            actionType: 'confirm',
        ...
        this.registerStep({
            ...
            explanation: "We'll lock in the architecture decisions and record them in an ADR before we build any code.",
            actionType: 'confirm',
    ...
    async setupIdentity() {
        return {
            ok: true,
            summary: "We've prepared the IdentityEngine for you. This handles users, organizations, and login sessions. You can create your first user whenever you're ready!",
            artifacts: [
                {
                    type: 'sql',
    ...
    async setupCharter() {
        return {
            ok: true,
            summary: "CharterEngine will help you manage user consent. This is especially important if you're using AI or handling personal data. It keeps a permanent record of what users agreed to.",
            warnings: [
    ...
    async setupConfig() {
        return {
            ok: true,
            summary: "ConfigEngine lets you control features with switches. Turn things on for some users, off for others. Test safely before showing everyone.",
            warnings: [
                "ConfigEngine isn't installed yet. You can add it later when you need feature flags.",
            ],
        };
    }
    async confirmCompletion(session) {
    ...
    async freezeArchitecture(session) {
