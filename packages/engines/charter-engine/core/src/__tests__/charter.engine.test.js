...
const charter_engine_1 = require("../charter.engine");
describe('CharterEngine', () => {
    let engine;
    beforeEach(() => {
        engine = new charter_engine_1.CharterEngine();
    });
    ...
    describe('processDataRequest', () => {
        it('should complete data request', async () => {
            ...
            const processed = await engine.processDataRequest(request.id, 'completed', 'Data has been erased');
...
//# sourceMappingURL=charter.engine.test.js.map