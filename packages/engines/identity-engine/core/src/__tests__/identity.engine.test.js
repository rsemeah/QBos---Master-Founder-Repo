...
const identity_engine_1 = require("../identity.engine");
describe('IdentityEngine', () => {
    let engine;
    beforeEach(async () => {
        engine = new identity_engine_1.IdentityEngine();
        await engine.init();
    });
    afterEach(async () => {
    ...
    describe('createUser', () => {
        ...
        it('should fail when not initialized', async () => {
            const uninitEngine = new identity_engine_1.IdentityEngine();
...
//# sourceMappingURL=identity.engine.test.js.map